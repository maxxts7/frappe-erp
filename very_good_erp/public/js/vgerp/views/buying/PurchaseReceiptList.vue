...
function openDoc(name) { window.open(`/app/purchase-receipt/${name}`, "_blank"); }
function createNew() { window.open("/app/purchase-receipt/new-purchase-receipt-1", "_blank"); }
...
<template>
	<div class="p-8">
		<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.5rem;">
			<div>
				<h1 style="font-family:'DM Serif Display',Georgia,serif;font-size:24px;color:#1A1714;letter-spacing:-.02em;margin:0 0 3px;">Purchase Receipts</h1>
				<p style="font-size:12.5px;color:#9C9086;margin:0;">Buying &rsaquo; Purchase Receipts</p>
			</div>
		...
		<input v-model="search" placeholder="Search receipts…"
